---
description: Show the area tree from the registry
...
1. **MCP (preferred):** call `agents_areas` with the arguments above.
2. **Shell fallback** from workspace root: `agents areas`
