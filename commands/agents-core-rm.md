---
description: Unmark a capability as core for an area
...
1. **MCP (preferred):** call `agents_core_rm` with the arguments above.
2. **Shell fallback** from workspace root: `agents core rm <path> <name>`
